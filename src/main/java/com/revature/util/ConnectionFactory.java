...
//Object to build Connection Objects
public class ConnectionFactory {
	...
	//this is a very basic factory only a single param for configuration
	//if we are making a singleton all of our constructores must be private otherwise others could make new instances
	...
	//this is designed with only one thread in mind and only needing one conncetion 
